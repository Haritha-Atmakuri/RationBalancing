...
class NutrientsRange{
    ...
    func addNutrients(){
        ...
        nutrients = [Nutreints.init(cattleWeight: "440", growthRequirement: 1.1 , nutrientType: "NEg", value: 1.27),Nutreints.init(cattleWeight: "440", growthRequirement: 2.2 , nutrientType: "NEg", value: 2.72),Nutreints.init(cattleWeight: "440", growthRequirement: 3.3, nutrientType: "NEg", value: 4.24),Nutreints.init(cattleWeight: "440", growthRequirement: 4.4, nutrientType: "NEg", value: 5.81),
                ...
                Nutreints.init(cattleWeight: "550", growthRequirement: 1.1 , nutrientType: "Ca", value: 15),Nutreints.init(cattleWeight: "550", growthRequirement: 2.2 , nutrientType: "Ca", value: 26),Nutreints.init(cattleWeight: "550", growthRequirement: 3.3, nutrientType: "Ca", value: 34),Nutreints.init(cattleWeight: "550", growthRequirement: 4.4, nutrientType: "Ca", value: 52),
                Nutreints.init(cattleWeight: "550", growthRequirement: 1.1 , nutrientType: "P", value: 7),Nutreints.init(cattleWeight: "550", growthRequirement: 2.2 , nutrientType: "P", value: 12),Nutreints.init(cattleWeight: "550", growthRequirement: 3.3, nutrientType: "P", value: 15),Nutreints.init(cattleWeight: "550", growthRequirement: 4.4, nutrientType: "P", value: 23),
                Nutreints.init(cattleWeight: "550", growthRequirement: 1.1 , nutrientType: "NEg", value: 1.19),Nutreints.init(cattleWeight: "550", growthRequirement: 2.2 , nutrientType: "NEg", value: 2.7),Nutreints.init(cattleWeight: "550", growthRequirement: 3.3, nutrientType: "NEg", value: 4.21),Nutreints.init(cattleWeight: "550", growthRequirement: 4.4, nutrientType: "NEg", value: 5.91)]
